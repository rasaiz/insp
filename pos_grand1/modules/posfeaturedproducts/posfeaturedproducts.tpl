	...
	<div class="container">
		<div class="container-inner">
				<div class="featured_product">
					...
					<div class="pos-title">
						<h2>{$title}</h2>
						<p class="description">{l s='Browse the collection of our featured products, You’ll definitely find' mod='posfeaturedproducts'} <span>{l s='what you are looking for.' mod='posfeaturedproducts'}</span></p>
					</div>
					{/if}
		...
		$(document).ready(function() {
			...
			featuredSlide.owlCarousel({
				...
				afterAction: function(){
					...
					$('.pos_featured_product .owl-wrapper .active:first').addClass('visible-item');
					$('.pos_featured_product .owl-wrapper .active:last').addClass('visible-item');
				},
			});
		});
	</script>
