												...
												<div class="actions">
													<div class="actions-inner">
														<ul class="add-to-links">
															...
															{/if}
															<li>
																<a class="addToWishlist wishlistProd_{$accessory.id_product|intval}" data-toggle="tooltip" data-placement="top" data-original-title="Wishlist"  href="#" data-wishlist="{$accessory.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$accessory.id_product|intval}', false, 1); return false;">
