...
<div class="pos_featured_product block_product">
		<div class="container-inner">
				<div class="featured_product">
					...
					<div class="pos-title">
						<h2>{$title}</h2>
						<!-- <p class="description">{l s='Browse the collection of our new products, You’ll definitely find' mod='posfeaturedproducts'} <span>{l s='what you are looking for.' mod='posfeaturedproducts'}</span></p> -->
					</div>
					{/if}
									...
									<div class="item-product">
										<div class="products-inner">
											<a class ="bigpic_{$product.id_product}_tabcategory product_image" href="{$product.link|escape:'html'}" title="{$product.name|escape:html:'UTF-8'}">
												<img class="img-responsive" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'medium_default')|escape:'html'}" alt="{$product.name|escape:html:'UTF-8'}" />
												{hook h="rotatorImg" product=$product}									
											</a>
											<!-- {if isset($product.new) && $product.new == 1}
												<a class="new-box" href="{$product.link|escape:'html':'UTF-8'}">
													<span class="new">{l s='New' mod='posfeaturedproducts'}</span>
												</a>
											{/if}
											{if isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}
												<a class="sale-box" href="{$product.link|escape:'html':'UTF-8'}">
													<span class="sale">{l s='Sale!' mod='posfeaturedproducts'}</span>
												</a>
											{/if} -->
												...
												<div class="actions-inner">
													<ul class="add-to-links">
														...
														{if isset($comparator_max_item) && $comparator_max_item}
														  <a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}" title="{l s='Add to Compare' mod='posfeaturedproducts'}">{l s='Compare' mod='posfeaturedproducts'}  </a>
														 {/if}
														</li>
														<li>
