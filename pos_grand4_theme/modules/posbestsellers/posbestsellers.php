...
class posbestsellers extends Module
{
	...
	public function install()
	{
		...
		if (!parent::install()
			...
			|| !Configuration::updateValue('POS_FEATURED_NBR',12)
			|| !Configuration::updateValue('PRODUCT_ITEM',4)
			|| !Configuration::updateValue('PRODUCT_ROW',1)
	...
	public function hookblockPosition7($params) {
	    return $this->hookblockPosition1($params);
	}
