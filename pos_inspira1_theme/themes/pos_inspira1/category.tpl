...
{if isset($category)}
	{if $category->id AND $category->active}
		...
		{/if}
		<h1 class="page-heading{if (isset($subcategories) && !$products) || (isset($subcategories) && $products) || !isset($subcategories) && $products} product-listing{/if}">{include file="$tpl_dir./category-count.tpl"}</h1>
		...
		{if $products}
			<div class="content_sortPagiBar clearfix">
            	<div class="sortPagiBar clearfix">
					<div class="col-xs-12 col-sm-4 border">{include file="./product-compare.tpl" paginationId='bottom'}</div>
					<div class="col-xs-12 col-sm-8">{include file="./product-sort.tpl"}</div>
				</div>
