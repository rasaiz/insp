...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		<link rel="stylesheet" href="{$css_dir}pe-icon-7-stroke.css" type="text/css" />
	...
	{if !isset($content_only) || !$content_only}
		...
		{/if}
		<div id="page"{if $page_name !="index" && $page_name !="category"} class="sub-page"{/if}>
			<div class="header-container">
				<header id="header">
					...
					<div class="header-middle">
						<div class="pos_logo col-lg-2 col-md-3 col-sm-3 col-xs-12">
							<a href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{$shop_name|escape:'html':'UTF-8'}">
								<img class="logo img-responsive" src="{$logo_url}" alt="{$shop_name|escape:'html':'UTF-8'}"{if isset($logo_image_width) && $logo_image_width} width="{$logo_image_width}"{/if}{if isset($logo_image_height) && $logo_image_height} height="{$logo_image_height}"{/if}/>
							</a>
						</div>
						<div class="header-middle-right col-lg-10 col-md-9 col-sm-9 col-xs-12">
							<nav>
							...
							<div class="pos-megamenu col-sm-9">
				...
				<div class="container">
					{capture name='listcategory'}{hook h='listcategory'}{/capture}
					{if $smarty.capture.listcategory}
					{$smarty.capture.listcategory}
					{/if}
				</div>
				<div class="container">
				...
				<div class="banner-category" >
					<div class="ct_img">
						...
						<div class="ct_breadcrumb_name">
							<h1 class="cat-name{if (isset($subcategories) && !$products) || (isset($subcategories) && $products) || !isset($subcategories) && $products} product-listing{/if}">{$category->name|escape:'html':'UTF-8'}{if isset($categoryNameComplement)}&nbsp;{$categoryNameComplement|escape:'html':'UTF-8'}{/if}</h1>
							{if $page_name !="index"}
			...
			{if $page_name !="index" && $page_name !="category"}
				<div class="breadcrumb-wapper-product">
					<div class="container">
						{if $page_name !='index' && $page_name !='pagenotfound'}
							{include file="$tpl_dir./breadcrumb.tpl"}
						{/if}
