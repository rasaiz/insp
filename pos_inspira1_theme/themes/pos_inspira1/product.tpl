...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		<div class="{if !$content_only} col-sm-9 col-md-9 col-xs-12{else} quick-view-body col-sm-12 col-md-12 col-xs-12{/if}">
			<div class="row">
			{if !$content_only}
				<div class="container">
							...
							<div class="box-info-product">
								...
								<div class="box-cart-bottom">
									...
									<ul id="usefull_link_block" class="clearfix no-print">
										<li>{if $HOOK_EXTRA_LEFT}{$HOOK_EXTRA_LEFT}{/if}</li>
										<li class="print">
		...
		{if !$content_only} 
			{capture name='displayRightColumn'}{hook h='displayRightColumn'}{/capture}
			{if $smarty.capture.displayRightColumn}
			{$smarty.capture.displayRightColumn}
			{/if}
		{/if}
		</div>
												...
												<div class="actions">
													<div class="actions-inner">
														<ul class="add-to-links">
															...
															{/if}
															<li>
																<a class="addToWishlist add-wishlist wishlistProd_{$accessory.id_product|intval}" data-toggle="tooltip" data-placement="top" data-original-title="Wishlist"  href="#" data-wishlist="{$accessory.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$accessory.id_product|intval}', false, 1); return false;">
															...
															<li>	
																{if isset($comparator_max_item) && $comparator_max_item}
																  <a class="add_to_compare" data-toggle="tooltip" data-placement="top" data-original-title="Compare"  href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}">{l s='Add to Compare'}
															...
															{if isset($quick_view) && $quick_view}
																<a class="quick-view" title="{l s='Quick view'}" href="{$accessory.link|escape:'html':'UTF-8'}" >
